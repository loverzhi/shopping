...
package cn.gatherlife.core.utils;

import cn.gatherlife.core.page.PageRequest;
import cn.gatherlife.core.xss.SQLFilter;
...
public class Query<T> extends LinkedHashMap<String, Object> {
    ...
    public Query(PageRequest pageRequest){
        Map<String, String> params = pageRequest.getColumnFilters();
        this.putAll(params);

        //分页参数
        if(pageRequest.getPageNum() != null && pageRequest.getPageNum() != 0){
            currPage = pageRequest.getPageNum();
        }else{
            currPage = 1;
        }
